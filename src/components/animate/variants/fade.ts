import { varTranEnter, varTranExit } from '@components/animate/variants'
...
export const varFade = (props?: {
	...
	durationIn?: number
	durationOut?: number
	easeIn?: TransitionEasing | [number, number, number, number]
	easeOut?: TransitionEasing | [number, number, number, number]
}) => {
